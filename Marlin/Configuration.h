...
* As at Jul 19, 2023
* ------------------
* Think this is the firmware to compile (Looking good post-flash).
* Recompiling to get Z probe working.
* Key changes are:
* 
* in config.H
* #define FIX_MOUNTED_PROBE  (uncomment)
* 
* in configadv.H 
* #define G38_PROBE_TARGET (uncomment)
*
* in ./src/inc/Warnings.cpp, line 729 
* commented out the error forcing mandatory declaration of Z_SAFE_HOMING
*
*/
...
#define STRING_CONFIG_H_AUTHOR "(V1 Engineering, Ryan, Rob, 515D, 20230719a)" // "(none, default config)" // Who made the changes.
...
// ROB: Uncommented to enable the probe
